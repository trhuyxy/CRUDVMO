...
const RowTableCustomers = ({
  number,
  type = null,
  description: descriptionCustomers,
  ...
  return (
    <tbody>
      ...
      >
        ...
        <td
          className="w-2/12 sm:hidden text-left whitespace-nowrap overflow-hidden overflow-ellipsis"
          data-title="Description"
        >
          {descriptionCustomers}
        </td>
        <td className=" w-1/12 sm:w-2/12 text-center pl-5" data-title="Priority">
          {priorityCustomers}
        </td>
