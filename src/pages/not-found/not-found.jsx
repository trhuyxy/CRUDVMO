    ...
    <div className="h-4/5 sm:mt-32 items-center w-screen flex ">
      <div className="container flex flex-col md:flex-row justify-center px-5 text-gray-700">
        <div className="max-w-md">
          ...
          <Link
            to="/project-type"
            className="px-4 inline py-3 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-blue-600 active:bg-blue-600 hover:bg-blue-800"
          >
            back to homepage
          </Link>
        </div>
